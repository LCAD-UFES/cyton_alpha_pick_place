...
int main(int argc, char **argv)
{
    ...
    moveit::planning_interface::MoveGroup plan_group("arm_move_group");
    ...
    current_state.setToRandomPositions(current_state.getJointModelGroup("arm_move_group"));
    ...
    validity_request.group_name = "arm_move_group";
